...
(defn register-provider! []
  ; Register a hover for each language where you want it
  ; NB: A more general "*" pattern will not float the hover to the top
  (vscode/languages.registerHoverProvider "clojure" #js {:provideHover provide-hover})
  (vscode/languages.registerHoverProvider "typescript" #js {:provideHover provide-hover}))
