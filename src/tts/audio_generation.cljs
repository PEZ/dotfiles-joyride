(ns tts.audio-generation
  (:require
   ["vscode" :as vscode]
   [tts.audio-playback :as audio-playback]
   [promesa.core :as p]))
...
(defn voice-dir-path
  ...
  []
  (let [root (ws-root)]
    (vscode/Uri.joinPath root ".tts-out")))
...
(comment
  ...
  (tts.audio-playback/load-and-play-audio!+ "slides/voice/demo-tts.mp3")
